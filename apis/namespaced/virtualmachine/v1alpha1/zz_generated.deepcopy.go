...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *Graphics3DInitParameters) DeepCopyInto(out *Graphics3DInitParameters) {
	*out = *in
	if in.Memory != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new Graphics3DInitParameters.
func (in *Graphics3DInitParameters) DeepCopy() *Graphics3DInitParameters {
	if in == nil {
		return nil
	}
	out := new(Graphics3DInitParameters)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *Graphics3DObservation) DeepCopyInto(out *Graphics3DObservation) {
	*out = *in
	if in.Memory != nil {
		in, out := &in.Memory, &out.Memory
		*out = new(float64)
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new Graphics3DObservation.
func (in *Graphics3DObservation) DeepCopy() *Graphics3DObservation {
	if in == nil {
		return nil
	}
	out := new(Graphics3DObservation)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *Graphics3DParameters) DeepCopyInto(out *Graphics3DParameters) {
	*out = *in
	if in.Memory != nil {
		in, out := &in.Memory, &out.Memory
		*out = new(float64)
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new Graphics3DParameters.
func (in *Graphics3DParameters) DeepCopy() *Graphics3DParameters {
	if in == nil {
		return nil
	}
	out := new(Graphics3DParameters)
	in.DeepCopyInto(out)
	return out
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *VideoCardInitParameters) DeepCopyInto(out *VideoCardInitParameters) {
	*out = *in
	if in.Graphics3D != nil {
		in, out := &in.Graphics3D, &out.Graphics3D
		*out = make([]Graphics3DInitParameters, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
	...
	if in.TotalVideoMemory != nil {
		in, out := &in.TotalVideoMemory, &out.TotalVideoMemory
		*out = new(float64)
		**out = **in
	}
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new VideoCardInitParameters.
func (in *VideoCardInitParameters) DeepCopy() *VideoCardInitParameters {
	if in == nil {
		return nil
	}
	out := new(VideoCardInitParameters)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *VideoCardObservation) DeepCopyInto(out *VideoCardObservation) {
	*out = *in
	if in.DeviceAddress != nil {
		in, out := &in.DeviceAddress, &out.DeviceAddress
		*out = new(string)
	...
	if in.Graphics3D != nil {
		in, out := &in.Graphics3D, &out.Graphics3D
		*out = make([]Graphics3DObservation, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new VideoCardObservation.
func (in *VideoCardObservation) DeepCopy() *VideoCardObservation {
	if in == nil {
		return nil
	}
	out := new(VideoCardObservation)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *VideoCardParameters) DeepCopyInto(out *VideoCardParameters) {
	*out = *in
	if in.Graphics3D != nil {
		in, out := &in.Graphics3D, &out.Graphics3D
		*out = make([]Graphics3DParameters, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new VideoCardParameters.
func (in *VideoCardParameters) DeepCopy() *VideoCardParameters {
	if in == nil {
		return nil
	}
	out := new(VideoCardParameters)
	in.DeepCopyInto(out)
	return out
}
...
func (in *VirtualMachineInitParameters) DeepCopyInto(out *VirtualMachineInitParameters) {
	*out = *in
	...
	if in.NumCoresPerNumaNode != nil {
		in, out := &in.NumCoresPerNumaNode, &out.NumCoresPerNumaNode
		*out = new(float64)
		**out = **in
	}
	...
	if in.VideoCard != nil {
		...
		*out = make([]VideoCardInitParameters, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
func (in *VirtualMachineNetworkInterfaceInitParameters) DeepCopyInto(out *VirtualMachineNetworkInterfaceInitParameters) {
	*out = *in
	...
	if in.ExternalPortID != nil {
		in, out := &in.ExternalPortID, &out.ExternalPortID
		*out = new(string)
		**out = **in
	}
...
func (in *VirtualMachineObservation) DeepCopyInto(out *VirtualMachineObservation) {
	*out = *in
	...
	if in.VideoCard != nil {
		in, out := &in.VideoCard, &out.VideoCard
		*out = make([]VideoCardObservation, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
func (in *VirtualMachineParameters) DeepCopyInto(out *VirtualMachineParameters) {
	*out = *in
	...
	if in.VideoCard != nil {
		in, out := &in.VideoCard, &out.VideoCard
		*out = make([]VideoCardParameters, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}

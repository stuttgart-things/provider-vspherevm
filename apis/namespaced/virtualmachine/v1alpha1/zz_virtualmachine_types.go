...
type DiskInitParameters struct {
	...
	// The type of storage controller to attach the  disk to. Can be scsi, sata, nvme or ide. You must have the appropriate number of controllers enabled for the selected type. Default scsi.
	...
	// The disk number on the storage bus. The maximum value for this setting is the value of the controller count times the controller capacity (15 for SCSI, 30 for SATA, 2 for IDE, and 64 fo NVMe). Duplicate unit numbers are not allowed. Default 0, for which one disk must be set to.
...
type Graphics3DInitParameters struct {
	...
	Renderer *string `json:"renderer,omitempty" tf:"renderer,omitempty"`
}

type Graphics3DObservation struct {
...
type Graphics3DParameters struct {
...
type OvfDeployInitParameters struct {
	...
	// The disk provisioning type. If set, all the disks included in the OVF/OVA will have the same specified policy. One of thin, thick, or eagerZeroedThick.
...
type VideoCardInitParameters struct {

	// 3D graphics options.
	Graphics3D []Graphics3DInitParameters `json:"graphics3D,omitempty" tf:"graphics_3d,omitempty"`

	// The number of supported displays.
	// Number of supported displays
	NumDisplays *float64 `json:"numDisplays,omitempty" tf:"num_displays,omitempty"`

	// The total video memory buffer in megabytes.
	// Video RAM size in megabytes
	TotalVideoMemory *float64 `json:"totalVideoMemory,omitempty" tf:"total_video_memory,omitempty"`
}

type VideoCardObservation struct {
	...
	// 3D graphics options.
	Graphics3D []Graphics3DObservation `json:"graphics3D,omitempty" tf:"graphics_3d,omitempty"`
...
type VideoCardParameters struct {

	// 3D graphics options.
	// +kubebuilder:validation:Optional
	Graphics3D []Graphics3DParameters `json:"graphics3D,omitempty" tf:"graphics_3d,omitempty"`

	// The number of supported displays.
	// Number of supported displays
	// +kubebuilder:validation:Optional
	NumDisplays *float64 `json:"numDisplays" tf:"num_displays,omitempty"`

	// The total video memory buffer in megabytes.
	// Video RAM size in megabytes
	// +kubebuilder:validation:Optional
	TotalVideoMemory *float64 `json:"totalVideoMemory" tf:"total_video_memory,omitempty"`
}
...
type VirtualMachineInitParameters struct {
	...
	// Enhanced vMotion Compatibility mode. Removing the value for this attribute disables EVC.
	// Enhanced vMotion Compatibility mode.
	EvcMode *string `json:"evcMode,omitempty" tf:"evc_mode,omitempty"`
	...
	// The hardware version number. Allows versions within ranges: 4, 7-11, 13-15, 17-22. The hardware version cannot be downgraded. See virtual machine hardware versions and compatibility for more information on supported settings.
	...
	// If set true, memory resource reservation for this virtual machine will always be equal to the virtual machine's memory size.
	...
	// The number of cores per NUMA node in the virtual machine. If 0 is specified a value will be determined automatically at power on.
	...
	NumCoresPerNumaNode *float64 `json:"numCoresPerNumaNode,omitempty" tf:"num_cores_per_numa_node,omitempty"`

	// The number of cores per socket in the virtual machine. The number of vCPUs on the virtual machine will be num_cpus divided by num_cores_per_socket. If specified, the value supplied to num_cpus must be evenly divisible by this value. If 0 is specified a value will be determined automatically at power on. Default: 1.
	...
	// The number of NVMe controllers that the virtual machine. This directly affects the number of disks you can add to the virtual machine and the maximum disk unit number. Note that lowering this value does not remove controllers. Default: 0. This directly affects the amount of disks you can add to the virtual machine and the maximum disk unit number. Note that lowering this value does not remove controllers.
	...
	// block in its configuration creates the video card device with the specified settings.
	// A specification for a video card device on this virtual machine.
	VideoCard []VideoCardInitParameters `json:"videoCard,omitempty" tf:"video_card,omitempty"`
...
type VirtualMachineNetworkInterfaceInitParameters struct {
	...
	// When VMware Tools is not running.
	...
	// The external port id to be bound to the VM port. This attribute will contain the port ID which was set by external network management plane. A user can choose to force a specific predefined port id which has been configured on the external network management plane.
	// The external port id to be bound to the VM port.
	ExternalPortID *string `json:"externalPortId,omitempty" tf:"external_port_id,omitempty"`
...
type VirtualMachineObservation struct {
	...
	// block in its configuration creates the video card device with the specified settings.
	// A specification for a video card device on this virtual machine.
	VideoCard []VideoCardObservation `json:"videoCard,omitempty" tf:"video_card,omitempty"`
...
type VirtualMachineParameters struct {
	...
	// A specification for a video card device on this virtual machine.
	// +kubebuilder:validation:Optional
	VideoCard []VideoCardParameters `json:"videoCard,omitempty" tf:"video_card,omitempty"`
...
type WindowsOptionsInitParameters struct {
	...
	// Specifies whether or not the virtual machine automatically logs on as Administrator. Default: false. Make sure that auto_logon_count is not set to 0 if auto_logon is true.
...
// VirtualMachine is the Schema for the VirtualMachines API. Provides a resource for VMware vSphere virtual machines. This resource can be used to create, modify, and delete virtual machines.
